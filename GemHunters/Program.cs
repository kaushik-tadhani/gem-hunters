...
class Program
{
    ...
    static public void Main(string[] args)
    {
        ...
        string player1Name = Console.ReadLine() ?? GameElement.PLAYER_1_ALIAS;  // Default to "P1" if no input is provided

        // Prompt the user to enter the name for Player 2
        Console.Write("\nPlease enter player 2 name : ");
        string player2Name = Console.ReadLine() ?? GameElement.PLAYER_2_ALIAS; // Default to "P2" if no input is provided
